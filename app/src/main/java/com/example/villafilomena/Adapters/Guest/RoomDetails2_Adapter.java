...
public class RoomDetails2_Adapter extends RecyclerView.Adapter<RoomDetails2_Adapter.ViewHolder> {
    ArrayList<RoomCottageDetails_Model> detailsHolder;

    public RoomDetails2_Adapter(ArrayList<RoomCottageDetails_Model> detailsHolder) {
